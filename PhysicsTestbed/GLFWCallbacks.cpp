...
{
	Testbed* programPointer = (Testbed*)glfwGetWindowUserPointer(window);	//This is an unsafe coercive cast, but we just have to be careful and live with it.
...
{
	Testbed* programPointer = (Testbed*)glfwGetWindowUserPointer(window);
	if (yDelta > 0)
	{
